#-------------------------------------------------------------------------
# AUTHOR: Kayla Nguyen
# FILENAME: kaylanguyen_assignment3q7.py
# SPECIFICATION: Finding which combinations of four SVM hyperparameters that leads
# to best prediction performance. 
    ...
    for d in degree: #iterates over degree
        for k in kernel: #iterates kernel
           for de in decision_function_shape: #iterates over decision_function_shape
                ...
                #--> add your Python code here
                if numCorrect/(numCorrect+numWrong) > accuracy:
                    accuracy = numCorrect/(numCorrect+numWrong)
                    print('Highest SVM accuracy so far:' , accuracy , ", Parameters: c =" , i , ", degree =" , d , ", kernels =" , k , ", decision_function_shape =", de)
                numCorrect = 0
                numWrong = 0
